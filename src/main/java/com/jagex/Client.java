...
import com.jagex.drawing.DrawingArea;
import com.jagex.drawing.RSInterface;
import com.jagex.drawing.Sprite;
import com.jagex.drawing.TextDrawingArea;
import com.jagex.drawing.TextInput;
import com.jagex.net.Flo;
import com.jagex.net.IDK;
import com.jagex.net.ISAACRandomGen;
import com.jagex.net.JagBuffer;
import com.jagex.net.RSSocket;
import com.jagex.net.SpotAnim;
import com.jagex.net.StreamLoader;
import com.jagex.net.VarBit;
import com.jagex.net.Varp;
import com.jagex.sign.Signlink;
import com.jagex.unrefactored.Class11;
import com.jagex.unrefactored.Class30_Sub1;
import com.jagex.unrefactored.Class36;
import com.jagex.util.Censor;
import com.jagex.util.Decompressor;
import com.jagex.util.MouseDetection;
import com.jagex.util.SizeConstants;
import com.jagex.util.TextClass;
import com.jagex.util.ondemand.OnDemandData;
import com.jagex.util.ondemand.OnDemandFetcher;
import com.jagex.world.Node;
import com.jagex.world.NodeList;
import com.jagex.world.Sounds;
import com.jagex.world.Texture;
import com.jagex.world.WorldController;
import com.jagex.world.animable.Animable;
import com.jagex.world.animable.Animable_Sub3;
import com.jagex.world.animable.Animable_Sub4;
import com.jagex.world.animable.Animable_Sub5;
import com.jagex.world.animable.Model;
import com.jagex.world.animable.entity.Animation;
import com.jagex.world.animable.entity.Entity;
import com.jagex.world.animable.entity.EntityDef;
import com.jagex.world.animable.entity.npc.NPC;
import com.jagex.world.animable.entity.player.Player;
import com.jagex.world.animable.entity.player.Skills;
import com.jagex.world.animable.item.Item;
import com.jagex.world.animable.item.ItemDef;
import com.jagex.world.animable.object.Object1;
import com.jagex.world.animable.object.Object2;
import com.jagex.world.animable.object.Object3;
...
public class Client extends RSApplet {
    ...
    public void drawChannelButtons() {
        ...
        aTextDrawingArea_1271.method389(true, 422, 0xffffff, "Report Abuse",
                147);
        aTextDrawingArea_1271.method389(true, 25, 0xffffff, "Public chat", 142);
        aTextDrawingArea_1271.method389(true, 150, 0xffffff, "Private chat",
                142);
        aTextDrawingArea_1271.method389(true, 285, 0xffffff, "Trade/compete",
                142);
        aTextDrawingArea_1271.method382(textColor[publicChatMode], 55,
                text[publicChatMode], 153, true);
        aTextDrawingArea_1271.method382(textColor[privateChatMode], 180,
                text[privateChatMode], 153, true);
        aTextDrawingArea_1271.method382(textColor[tradeMode], 325,
                text[tradeMode], 153, true);
    }
        ...
        if (messagePromptRaised) {
            ...
            for (int k = 0; k < 100; k++)
                if (chatMessages[k] != null) {
                    ...
                    if (l == 0) {
                        if (i1 > 0 && i1 < 110)
                            textDrawingArea.method389(false, 19, 19,
                                    chatMessages[k], i1);
                        j++;
                    }
                    ...
                    if (l == 4 && (tradeMode == 0 || tradeMode == 1 && isFriendOrSelf(s1))) {
                        if (i1 > 0 && i1 < 110)
                            textDrawingArea.method385(0x800080,
                                    s1 + " " + chatMessages[k], i1, 18);
                        j++;
                    }
            ...
            textDrawingArea.drawChatInput(255, 20 + textDrawingArea
                    .getTextWidth(s + ": "), inputString + "*", 110, false);
    ...
    public static final byte[] ReadFile(String s) {
        try {
            ...
            logger.log(Level.WARNING, "Error while reading file: " + s, e);
            return null;
        }
    }
    ...
    private void method22() {
        try {
            ...
            if (!aBoolean1159) {
                ...
                if (anInt1097 > 160) {
                    anInt1097 = 0;
                    jagBuffer.createFrame(238);
                    jagBuffer.writeWordBigEndian(96);
                }
                jagBuffer.createFrame(0);
        ...
        if (super.gameFrame != null) {
            jagBuffer.createFrame(210);
            jagBuffer.writeDWord(0x3f008edd);
        }
    ...
    private void method24(int i) {
        ...
        int j1 = ((238 + (int) (Math.random() * 20D)) - 10 << 16) + ((238 + (int) (Math
                .random() * 20D)) - 10 << 8) + ((238 + (int) (Math.random() * 20D)) - 10);
    ...
    private void method26(boolean flag) {
        for (int j = 0; j < npcCount; j++) {
            ...
            worldController.method285(plane, npc.anInt1552, method42(plane,
                    npc.y, npc.x), k, npc.y, (npc.anInt1540 - 1) * 64 + 60, npc.x,
                    npc, npc.aBoolean1541);
        }
    }
    ...
    private void updateNPCs(JagBuffer jagBuffer, int i) {
        anInt839 = 0;
        anInt893 = 0;
        method139(jagBuffer);
        method46(i, jagBuffer);
        method86(jagBuffer);
        ...
        if (jagBuffer.currentOffset != i) {
            Signlink
                    .reporterror(myUsername + " size mismatch in getnpcpos - pos:" + jagBuffer.currentOffset + " psize:" + i);
            throw new RuntimeException("eek");
        }
        for (int i1 = 0; i1 < npcCount; i1++)
            if (npcArray[npcIndices[i1]] == null) {
                Signlink
                        .reporterror(myUsername + " null entry in npc list - pos:" + i1 + " size:" + npcCount);
                throw new RuntimeException("eek");
            }
    ...
    private void processChatModeClick() {
        if (super.clickMode3 == 1) {
            if (super.saveClickX >= 6 && super.saveClickX <= 106 && super.saveClickY >= 467 && super.saveClickY <= 499) {
                ...
                aBoolean1233 = true;
                inputTaken = true;
                jagBuffer.createFrame(95);
                jagBuffer.writeWordBigEndian(publicChatMode);
                jagBuffer.writeWordBigEndian(privateChatMode);
                jagBuffer.writeWordBigEndian(tradeMode);
            }
    ...
    private void delFriend(long l) {
        try {
            ...
            for (int i = 0; i < friendsCount; i++) {
                ...
                jagBuffer.createFrame(215);
                jagBuffer.writeQWord(l);
                break;
            }
        } catch (RuntimeException runtimeexception) {
            Signlink
                    .reporterror("18622, " + false + ", " + l + ", " + runtimeexception
                            .toString());
    ...
    private void method37(int j) {
        if (!lowMem) {
            if (Texture.anIntArray1480[17] >= j) {
                ...
                if (anInt854 > 1235) {
                    anInt854 = 0;
                    jagBuffer.createFrame(226);
                    jagBuffer.writeWordBigEndian(0);
                    int l2 = jagBuffer.currentOffset;
                    jagBuffer.writeWord(58722);
                    jagBuffer.writeWordBigEndian(240);
                    jagBuffer.writeWord((int) (Math.random() * 65536D));
                    jagBuffer.writeWordBigEndian((int) (Math.random() * 256D));
                    if ((int) (Math.random() * 2D) == 0)
                        jagBuffer.writeWord(51825);
                    jagBuffer.writeWordBigEndian((int) (Math.random() * 256D));
                    jagBuffer.writeWord((int) (Math.random() * 65536D));
                    jagBuffer.writeWord(7130);
                    jagBuffer.writeWord((int) (Math.random() * 65536D));
                    jagBuffer.writeWord(61657);
                    jagBuffer.writeBytes(jagBuffer.currentOffset - l2);
                }
            }
        ...
        try {
            ...
            for (int j = 0; j < ignoreCount; j++)
                if (ignoreListAsLongs[j] == l) {
                    pushMessage(
                            "Please remove " + s + " from your ignore list first",
                            0, "");
                    return;
                }
            ...
            if (s.equals(myPlayer.name)) {
                ...
                friendsCount++;
                needDrawTabArea = true;
                jagBuffer.createFrame(188);
                jagBuffer.writeQWord(l);
                return;
            }
        } catch (RuntimeException runtimeexception) {
            Signlink
                    .reporterror("15283, " + (byte) 68 + ", " + l + ", " + runtimeexception
                            .toString());
        }
        throw new RuntimeException();
    }
    ...
    private void method45() {
        ...
        for (int j = 0; j < 7; j++) {
            ...
            for (int k = 0; k < IDK.length; k++) {
                if (IDK.cache[k].aBoolean662 || IDK.cache[k].anInt657 != j + (aBoolean1047 ? 0
                        : 7))
                    continue;
                anIntArray1065[j] = k;
                break;
    ...
    private void method46(int i, JagBuffer jagBuffer) {
        while (jagBuffer.bitPosition + 21 < i * 8) {
            ...
            int l = jagBuffer.readBits(5);
            if (l > 15)
                l -= 32;
            int i1 = jagBuffer.readBits(5);
            if (i1 > 15)
                i1 -= 32;
            int j1 = jagBuffer.readBits(1);
            npc.desc = EntityDef.forID(jagBuffer.readBits(12));
            int k1 = jagBuffer.readBits(1);
            if (k1 == 1)
        ...
        for (int l = 0; l < j; l++) {
            ...
            if (player.aModel_1714 != null && loopCycle >= player.anInt1707 && loopCycle < player.anInt1708) {
                ...
                worldController.method286(plane, player.y, player,
                        ...
                        player.anInt1709, player.anInt1719, player.anInt1721, i1,
                        player.anInt1720);
                continue;
            }
    ...
    private boolean promptUserForInput(RSInterface class9) {
            ...
            if (i2 != -1) {
                do {
                    ...
                    if (j1 == 1 && ++i2 >= IDK.length)
                        i2 = 0;
                } while (IDK.cache[i2].aBoolean662 || IDK.cache[i2].anInt657 != k + (aBoolean1047 ? 0
                        : 7));
                anIntArray1065[k] = i2;
                aBoolean1031 = true;
            }
        ...
        if (j == 326) {
            jagBuffer.createFrame(101);
            jagBuffer.writeWordBigEndian(aBoolean1047 ? 0 : 1);
            for (int i1 = 0; i1 < 7; i1++)
                jagBuffer.writeWordBigEndian(anIntArray1065[i1]);

            for (int l1 = 0; l1 < 5; l1++)
                jagBuffer.writeWordBigEndian(anIntArray990[l1]);
        ...
        if (j >= 601 && j <= 612) {
            ...
            if (reportAbuseInput.length() > 0) {
                jagBuffer.createFrame(218);
                jagBuffer.writeQWord(TextClass.longForName(reportAbuseInput));
                jagBuffer.writeWordBigEndian(j - 601);
                jagBuffer.writeWordBigEndian(canMute ? 1 : 0);
            }
        }
        return false;
    }

    private void method49(JagBuffer jagBuffer) {
        for (int j = 0; j < anInt893; j++) {
            int k = anIntArray894[j];
            Player player = playerArray[k];
            int l = jagBuffer.readUnsignedByte();
            if ((l & 0x40) != 0)
                l += jagBuffer.readUnsignedByte() << 8;
            method107(l, k, jagBuffer, player);
        }
        ...
        if (k1 != 0) {
            ...
            if (class46_2.anInt758 != -1) {
                ...
                if (background_2 != null) {
                    ...
                    background_2.method361(48 + l * 4 + i6,
                            48 + (104 - i - class46_2.anInt761) * 4 + j6);
                }
            } else {
                if (i3 == 0 || i3 == 2)
                    if (k2 == 0) {
        ...
        if (k1 != 0) {
            ...
            if (class46_1.anInt758 != -1) {
                ...
                if (background_1 != null) {
                    ...
                    background_1.method361(48 + l * 4 + j5,
                            48 + (104 - i - class46_1.anInt761) * 4 + k5);
                }
            } else if (j3 == 9) {
                int l4 = 0xeeeeee;
                if (k1 > 0)
        ...
        if (k1 != 0) {
            ...
            if (class46.anInt758 != -1) {
                ...
                if (background != null) {
                    ...
                    background.method361(48 + l * 4 + i4,
                            48 + (104 - i - class46.anInt761) * 4 + j4);
                }
            }
        }
    }
    ...
    private void loadingStages() {
        ...
        if (loadingStage == 1) {
            ...
            if (j != 0 && System.currentTimeMillis() - aLong824 > 0x57e40L) {
                Signlink
                        .reporterror(myUsername + " glcfb " + aLong1215 + "," + j + "," + lowMem + "," + decompressors[0] + "," + onDemandFetcher
                                .getNodeCount() + "," + plane + "," + anInt1069 + "," + anInt1070);
                aLong824 = System.currentTimeMillis();
            }
        }
                    ...
                    if (npc != null && npc.x >= 0 && npc.x < 13312 && npc.y >= 0 && npc.y < 13312)
                        class30_sub2_sub4_sub4.method455(loopCycle, npc.y,
                                method42(class30_sub2_sub4_sub4.anInt1597, npc.y,
                                        npc.x) - class30_sub2_sub4_sub4.anInt1583,
                                npc.x);
                }
                if (class30_sub2_sub4_sub4.anInt1590 < 0) {
                    ...
                    if (player != null && player.x >= 0 && player.x < 13312 && player.y >= 0 && player.y < 13312)
                        class30_sub2_sub4_sub4
                                .method455(loopCycle, player.y, method42(
                                        class30_sub2_sub4_sub4.anInt1597, player.y,
    ...
    private void processOnDemandQueue() {
        do {
            ...
            } while (onDemandData.dataType != 93 || !onDemandFetcher
                    .method564(onDemandData.ID));
            ObjectManager.method173(new JagBuffer(onDemandData.buffer),
                    onDemandFetcher);
        } while (true);
    }
    ...
    private void calcFlamesPosition() {
        ...
        anIntArray969[c - 1] = (int) (Math.sin(loopCycle / 14D) * 16D + Math
                .sin(loopCycle / 15D) * 14D + Math.sin(loopCycle / 16D) * 12D);
        if (anInt1040 > 0)
            anInt1040 -= 4;
        if (anInt1041 > 0)
            anInt1041 -= 4;
    ...
    private void mainGameProcessor() {
        ...
        synchronized (mouseDetection.syncObject) {
            if (flagged) {
                if (super.clickMode3 != 0 || mouseDetection.coordsIndex >= 40) {
                    jagBuffer.createFrame(45);
                    jagBuffer.writeWordBigEndian(0);
                    int j2 = jagBuffer.currentOffset;
                    int j3 = 0;
                    for (int j4 = 0; j4 < mouseDetection.coordsIndex; j4++) {
                        if (j2 - jagBuffer.currentOffset >= 240)
                            break;
                        j3++;
                        ...
                        if (k5 == anInt1237 && l4 == anInt1238) {
                            ...
                            if (anInt1022 < 8 && j6 >= -32 && j6 <= 31 && k6 >= -32 && k6 <= 31) {
                                ...
                                k6 += 32;
                                jagBuffer
                                        .writeWord((anInt1022 << 12) + (j6 << 6) + k6);
                                anInt1022 = 0;
                            } else if (anInt1022 < 8) {
                                jagBuffer
                                        .writeDWordBigEndian(0x800000 + (anInt1022 << 19) + i6);
                                anInt1022 = 0;
                            } else {
                                jagBuffer
                                        .writeDWord(0xc0000000 + (anInt1022 << 19) + i6);
                                anInt1022 = 0;
                            }
                        }
                    }

                    jagBuffer.writeBytes(jagBuffer.currentOffset - j2);
        ...
        if (super.clickMode3 != 0) {
            ...
            if (super.clickMode3 == 2)
                j5 = 1;
            int l5 = (int) l;
            jagBuffer.createFrame(241);
            jagBuffer.writeDWord((l5 << 20) + (j5 << 19) + k4);
        }
        if (anInt1016 > 0)
            anInt1016--;
        ...
        if (aBoolean1017 && anInt1016 <= 0) {
            anInt1016 = 20;
            aBoolean1017 = false;
            jagBuffer.createFrame(86);
            jagBuffer.writeWord(anInt1184);
            jagBuffer.method432(minimapInt1);
        }
        if (super.awtFocus && !aBoolean954) {
            aBoolean954 = true;
            jagBuffer.createFrame(3);
            jagBuffer.writeWordBigEndian(1);
        }
        if (!super.awtFocus && aBoolean954) {
            aBoolean954 = false;
            jagBuffer.createFrame(3);
            ...
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 5) {
                    ...
                    if (lastActiveInvInterface == anInt1084 && mouseInvInterfaceIndex != anInt1085) {
                        ...
                        jagBuffer.createFrame(214);
                        jagBuffer.method433(anInt1084);
                        jagBuffer.method424(j1);
                        jagBuffer.method433(anInt1085);
                        jagBuffer.method431(mouseInvInterfaceIndex);
                    }
        ...
        if (anInt1010 > 50)
            jagBuffer.createFrame(0);
        try {
            if (socketStream != null && jagBuffer.currentOffset > 0) {
                socketStream.queueBytes(jagBuffer.currentOffset,
                        jagBuffer.buffer);
    ...
    public void drawLoadingText(int i, String s) {
        ...
        byte byte1 = 20;
        chatTextDrawingArea
                .drawText(0xffffff, "RuneScape is loading - please wait...",
                        c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
    ...
    private StreamLoader streamLoaderForName(int i, String s, String s1, int j,
        ...
        while (abyte0 == null) {
            ...
            try {
                ...
                JagBuffer jagBuffer = new JagBuffer(abyte1);
                jagBuffer.currentOffset = 3;
                int i2 = jagBuffer.readTriByte() + 6;
                int j2 = 6;
                abyte0 = new byte[i2];
    ...
    private void doAction(int i) {
        ...
        if (l == 582) {
            ...
            if (npc != null) {
                ...
                crossType = 2;
                crossIndex = 0;
                jagBuffer.createFrame(57);
                jagBuffer.method432(anInt1285);
                jagBuffer.method432(i1);
                jagBuffer.method431(anInt1283);
                jagBuffer.method432(anInt1284);
            }
        }
        if (l == 234) {
            ...
            crossType = 2;
            crossIndex = 0;
            jagBuffer.createFrame(236);
            jagBuffer.method431(k + baseY);
            jagBuffer.writeWord(i1);
            jagBuffer.method431(j + baseX);
        }
        if (l == 62 && method66(i1, k, j)) {
            jagBuffer.createFrame(192);
            jagBuffer.writeWord(anInt1284);
            jagBuffer.method431(i1 >> 14 & 0x7fff);
            jagBuffer.method433(k + baseY);
            jagBuffer.method431(anInt1283);
            jagBuffer.method433(j + baseX);
            jagBuffer.writeWord(anInt1285);
        }
        if (l == 511) {
            ...
            crossType = 2;
            crossIndex = 0;
            jagBuffer.createFrame(25);
            jagBuffer.method431(anInt1284);
            jagBuffer.method432(anInt1285);
            jagBuffer.writeWord(i1);
            jagBuffer.method432(k + baseY);
            jagBuffer.method433(anInt1283);
            jagBuffer.writeWord(j + baseX);
        }
        if (l == 74) {
            jagBuffer.createFrame(122);
            jagBuffer.method433(k);
            jagBuffer.method432(j);
            jagBuffer.method431(i1);
        ...
        if (l == 315) {
            ...
            if (flag8) {
                jagBuffer.createFrame(185);
                jagBuffer.writeWord(k);
            }
        }
        if (l == 561) {
            ...
            if (player != null) {
                ...
                anInt1188 += i1;
                if (anInt1188 >= 90) {
                    jagBuffer.createFrame(136);
                    anInt1188 = 0;
                }
                jagBuffer.createFrame(128);
                jagBuffer.writeWord(i1);
            }
        }
        if (l == 20) {
        ...
        if (l == 1062) {
            anInt924 += baseX;
            if (anInt924 >= 113) {
                jagBuffer.createFrame(183);
                jagBuffer.writeDWordBigEndian(0xe63271);
                anInt924 = 0;
            }
            method66(i1, k, j);
            jagBuffer.createFrame(228);
            jagBuffer.method432(i1 >> 14 & 0x7fff);
            jagBuffer.method432(k + baseY);
            jagBuffer.writeWord(j + baseX);
        }
        if (l == 679 && !aBoolean1149) {
            jagBuffer.createFrame(40);
            jagBuffer.writeWord(k);
            aBoolean1149 = true;
        }
        if (l == 431) {
            jagBuffer.createFrame(129);
            jagBuffer.method432(j);
            jagBuffer.writeWord(k);
            jagBuffer.method432(i1);
            atInventoryLoopCycle = 0;
        ...
        if (l == 53) {
            jagBuffer.createFrame(135);
            jagBuffer.method431(j);
            jagBuffer.method432(k);
            jagBuffer.method431(i1);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            atInventoryIndex = j;
        ...
        if (l == 539) {
            jagBuffer.createFrame(16);
            jagBuffer.method432(i1);
            jagBuffer.method433(j);
            jagBuffer.method433(k);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            atInventoryIndex = j;
        ...
        if (l == 484 || l == 6) {
            ...
            if (l1 != -1) {
                ...
                for (int j3 = 0; j3 < playerCount; j3++) {
                    ...
                    if (class30_sub2_sub4_sub1_sub2_7 == null || class30_sub2_sub4_sub1_sub2_7.name == null || !class30_sub2_sub4_sub1_sub2_7.name
                            .equalsIgnoreCase(s7))
                        continue;
                    doWalkTo(2, 0, 1, 0, myPlayer.smallY[0], 1, 0,
                    ...
                    if (l == 484) {
                        jagBuffer.createFrame(139);
                        jagBuffer.method431(playerIndices[j3]);
                    }
                    if (l == 6) {
                        anInt1188 += i1;
                        if (anInt1188 >= 90) {
                        ...
                        jagBuffer.createFrame(128);
                        jagBuffer.writeWord(playerIndices[j3]);
                    }
                    flag9 = true;
                    break;
                }
        ...
        if (l == 870) {
            jagBuffer.createFrame(53);
            jagBuffer.writeWord(j);
            jagBuffer.method432(anInt1283);
            jagBuffer.method433(i1);
            jagBuffer.writeWord(anInt1284);
            jagBuffer.method431(anInt1285);
            jagBuffer.writeWord(k);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
            atInventoryIndex = j;
        ...
        if (l == 27) {
            ...
            if (class30_sub2_sub4_sub1_sub2_2 != null) {
                ...
                anInt986 += i1;
                if (anInt986 >= 54) {
                    jagBuffer.createFrame(189);
                    jagBuffer.writeWordBigEndian(234);
                    anInt986 = 0;
                }
                jagBuffer.createFrame(73);
                jagBuffer.method431(i1);
            }
        }
        if (l == 213) {
            ...
            crossType = 2;
            crossIndex = 0;
            jagBuffer.createFrame(79);
            jagBuffer.method431(k + baseY);
            jagBuffer.writeWord(i1);
            jagBuffer.method432(j + baseX);
        }
        if (l == 632) {
            jagBuffer.createFrame(145);
            jagBuffer.method432(k);
            jagBuffer.method432(j);
            jagBuffer.method432(i1);
            atInventoryLoopCycle = 0;
        ...
        if (l == 94) {
            ...
            crossType = 2;
            crossIndex = 0;
            jagBuffer.createFrame(181);
            jagBuffer.method431(k + baseY);
            jagBuffer.writeWord(i1);
            jagBuffer.method431(j + baseX);
            jagBuffer.method432(anInt1137);
        }
        if (l == 646) {
            jagBuffer.createFrame(185);
            jagBuffer.writeWord(k);
        ...
        if (l == 225) {
            ...
            if (class30_sub2_sub4_sub1_sub1_2 != null) {
                ...
                anInt1226 += i1;
                if (anInt1226 >= 85) {
                    jagBuffer.createFrame(230);
                    jagBuffer.writeWordBigEndian(239);
                    anInt1226 = 0;
                }
                jagBuffer.createFrame(17);
                jagBuffer.method433(i1);
            }
        }
        if (l == 965) {
            ...
            if (class30_sub2_sub4_sub1_sub1_3 != null) {
                ...
                anInt1134++;
                if (anInt1134 >= 96) {
                    jagBuffer.createFrame(152);
                    jagBuffer.writeWordBigEndian(88);
                    anInt1134 = 0;
                }
                jagBuffer.createFrame(21);
                jagBuffer.writeWord(i1);
            }
        }
        if (l == 413) {
        ...
        if (l == 900) {
            method66(i1, k, j);
            jagBuffer.createFrame(252);
            jagBuffer.method433(i1 >> 14 & 0x7fff);
            jagBuffer.method431(k + baseY);
            jagBuffer.method432(j + baseX);
        }
        if (l == 412) {
        ...
        if (l == 365) {
            ...
            if (class30_sub2_sub4_sub1_sub2_3 != null) {
                ...
                crossType = 2;
                crossIndex = 0;
                jagBuffer.createFrame(249);
                jagBuffer.method432(i1);
                jagBuffer.method431(anInt1137);
            }
        }
        if (l == 729) {
        ...
        if (l == 867) {
            if ((i1 & 3) == 0)
                anInt1175++;
            if (anInt1175 >= 59) {
                jagBuffer.createFrame(200);
                jagBuffer.writeWord(25501);
                anInt1175 = 0;
            }
            jagBuffer.createFrame(43);
            jagBuffer.method431(k);
            jagBuffer.method432(i1);
            jagBuffer.method432(j);
            atInventoryLoopCycle = 0;
            atInventoryInterface = k;
        ...
        if (l == 491) {
            ...
            if (class30_sub2_sub4_sub1_sub2_6 != null) {
                ...
                crossType = 2;
                crossIndex = 0;
                jagBuffer.createFrame(14);
                // stream.method432(anInt1284);
                jagBuffer.writeWord(i1); // Player id
                // stream.writeWord(anInt1285);
                jagBuffer.method431(anInt1283); // Item slot
            }
        }
        if (l == 639) {
        ...
        if (l == 478) {
            ...
            if (class30_sub2_sub4_sub1_sub1_7 != null) {
                ...
                if ((i1 & 3) == 0)
                    anInt1155++;
                if (anInt1155 >= 53) {
                    jagBuffer.createFrame(85);
                    jagBuffer.writeWordBigEndian(66);
                    anInt1155 = 0;
                }
                jagBuffer.createFrame(18);
                jagBuffer.method431(i1);
            }
        }
        if (l == 113) {
            method66(i1, k, j);
            jagBuffer.createFrame(70);
            jagBuffer.method431(j + baseX);
            jagBuffer.writeWord(k + baseY);
            jagBuffer.method433(i1 >> 14 & 0x7fff);
        }
        if (l == 872) {
            method66(i1, k, j);
            jagBuffer.createFrame(234);
            jagBuffer.method433(j + baseX);
            jagBuffer.method432(i1 >> 14 & 0x7fff);
            jagBuffer.method433(k + baseY);
        }
        if (l == 502) {
            method66(i1, k, j);
            jagBuffer.createFrame(132);
            jagBuffer.method433(j + baseX);
            jagBuffer.writeWord(i1 >> 14 & 0x7fff);
            jagBuffer.method432(k + baseY);
        }
        if (l == 1125) {
    ...
    public byte[] getModel(int Index) {
        try {
            File Model = new File(
                    Signlink.findcachedir() + "/models/" + Index + ".gz");
    ...
    private void method73() {
        do {
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if ((j >= 97 && j <= 122 || j >= 65 && j <= 90 || j >= 48 && j <= 57 || j == 32) && reportAbuseInput
                        .length() < 12)
                ...
                if (j == 13 || j == 10) {
                    ...
                    if (friendsListAction == 3 && promptInput.length() > 0) {
                        jagBuffer.createFrame(126);
                        jagBuffer.writeWordBigEndian(0);
                        int k = jagBuffer.currentOffset;
                        jagBuffer.writeQWord(aLong953);
                        TextInput.method526(promptInput, jagBuffer);
                        jagBuffer.writeBytes(jagBuffer.currentOffset - k);
                ...
                if ((!amountOrNameInput.toLowerCase().contains("k") && !amountOrNameInput
                        .toLowerCase().contains("m") && !amountOrNameInput
                        .toLowerCase().contains("b")) && (j == 107 || j == 109) || j == 98) {
                    amountOrNameInput += (char) j;
                    inputTaken = true;
                }
                ...
                if (j == 13 || j == 10) {
                    if (amountOrNameInput.length() > 0) {
                        ...
                        jagBuffer.createFrame(208);
                        jagBuffer.writeDWord(amount);
                    }
                    inputDialogState = 0;
                    inputTaken = true;
                }
                ...
                if (j == 13 || j == 10) {
                    if (amountOrNameInput.length() > 0) {
                        jagBuffer.createFrame(60);
                        jagBuffer.writeQWord(TextClass
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    ...
                    if (inputString.startsWith("::")) {
                        ...
                        jagBuffer.createFrame(103);
                        jagBuffer.writeWordBigEndian(inputString.length() - 1);
                        jagBuffer.writeString(inputString.substring(2));
                    } else {
                        ...
                        jagBuffer.createFrame(4);
                        jagBuffer.writeWordBigEndian(0);
                        int j3 = jagBuffer.currentOffset;
                        jagBuffer.method425(i3);
                        jagBuffer.method425(j2);
                        aStream_834.currentOffset = 0;
                        TextInput.method526(inputString, aStream_834);
                        jagBuffer.method441(0, aStream_834.buffer,
                                aStream_834.currentOffset);
                        jagBuffer.writeBytes(jagBuffer.currentOffset - j3);
        ...
        for (int j = 0; j < 100; j++)
            if (chatMessages[j] != null) {
                ...
                if (k == 6 && privateChatMode < 2) {
                    int j1 = 329 - i * 13;
                    textDrawingArea.method385(0,
                            "To " + s + ": " + chatMessages[j], j1, 4);
                    textDrawingArea.method385(65535,
                            "To " + s + ": " + chatMessages[j], j1 - 1, 4);
                    if (++i >= 5)
                        return;
                }
            }
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            int i = (int) (l >> 16 & 31L);
            jagBuffer.currentOffset = 0;
            jagBuffer.writeWordBigEndian(14);
            jagBuffer.writeWordBigEndian(i);
            socketStream.queueBytes(2, jagBuffer.buffer);
            for (int j = 0; j < 8; j++)
                socketStream.read();
            ...
            if (response == 0) {
                ...
                ai[3] = (int) aLong1215;
                jagBuffer.currentOffset = 0;
                jagBuffer.writeWordBigEndian(10);
                jagBuffer.writeDWord(ai[0]);
                jagBuffer.writeDWord(ai[1]);
                jagBuffer.writeDWord(ai[2]);
                jagBuffer.writeDWord(ai[3]);
                jagBuffer.writeDWord(Signlink.uid);
                jagBuffer.writeString(s);
                jagBuffer.writeString(s1);
                jagBuffer.handleRSA();
                ...
                aStream_847
                        .writeWordBigEndian(jagBuffer.currentOffset + 36 + 1 + 1 + 2);
                ...
                aStream_847.writeBytes(jagBuffer.buffer,
                        jagBuffer.currentOffset, 0);
                jagBuffer.encryption = new ISAACRandomGen(ai);
            ...
            if (response == -1) {
                ...
                logger.warning("Unexpected login response: " + response);
    ...
    private boolean doWalkTo(int i, int j, int k, int i1, int j1, int k1,
        ...
        while (i4 != l3) {
            ...
            if (i1 != 0) {
                if ((i1 < 5 || i1 == 10) && aClass11Array1230[plane].method219(
                        k2, j3, k3, j, i1 - 1, i2)) {
                    flag1 = true;
                    break;
                }
                if (i1 < 10 && aClass11Array1230[plane].method220(k2, i2, k3,
                        i1 - 1, j, j3)) {
                    flag1 = true;
                    break;
                }
            }
            if (k1 != 0 && k != 0 && aClass11Array1230[plane].method221(i2, k2,
                    j3, k, l1, k1, k3)) {
                flag1 = true;
                break;
            }
        ...
        if (i4 > 0) {
            ...
            anInt1288 += k4;
            if (anInt1288 >= 92) {
                jagBuffer.createFrame(36);
                jagBuffer.writeDWord(0);
                anInt1288 = 0;
            }
            if (i == 0) {
                jagBuffer.createFrame(164);
                jagBuffer.writeWordBigEndian(k4 + k4 + 3);
            }
            if (i == 1) {
                jagBuffer.createFrame(248);
                jagBuffer.writeWordBigEndian(k4 + k4 + 3 + 14);
            }
            if (i == 2) {
                jagBuffer.createFrame(98);
                jagBuffer.writeWordBigEndian(k4 + k4 + 3);
            }
            jagBuffer.method433(k6 + baseX);
            destX = bigX[0];
            destY = bigY[0];
            for (int j7 = 1; j7 < k4; j7++) {
                i4--;
                jagBuffer.writeWordBigEndian(bigX[i4] - k6);
                jagBuffer.writeWordBigEndian(bigY[i4] - i7);
            }

            jagBuffer.method431(i7 + baseY);
            jagBuffer.method424(super.keyArray[5] != 1 ? 0 : 1);
            return true;
        }
        return i != 1;
    }

    private void method86(JagBuffer jagBuffer) {
        for (int j = 0; j < anInt893; j++) {
            int k = anIntArray894[j];
            NPC npc = npcArray[k];
            int l = jagBuffer.readUnsignedByte();
            if ((l & 0x10) != 0) {
                int i1 = jagBuffer.method434();
                if (i1 == 65535)
                    i1 = -1;
                int i2 = jagBuffer.readUnsignedByte();
                if (i1 == npc.anim && i1 != -1) {
            ...
            if ((l & 8) != 0) {
                int j1 = jagBuffer.method426();
                int j2 = jagBuffer.method427();
                npc.updateHitData(j2, j1, loopCycle);
                npc.loopCycleStatus = loopCycle + 300;
                npc.currentHealth = jagBuffer.method426();
                npc.maxHealth = jagBuffer.readUnsignedByte();
            }
            if ((l & 0x80) != 0) {
                npc.anInt1520 = jagBuffer.readUnsignedShort();
                int k1 = jagBuffer.readDWord();
                npc.anInt1524 = k1 >> 16;
            ...
            if ((l & 0x20) != 0) {
                npc.interactingEntity = jagBuffer.readUnsignedShort();
                if (npc.interactingEntity == 65535)
                    npc.interactingEntity = -1;
            }
            if ((l & 1) != 0) {
                npc.textSpoken = jagBuffer.readString();
                npc.textCycle = 100;
                // entityMessage(npc);

            }
            if ((l & 0x40) != 0) {
                int l1 = jagBuffer.method427();
                int k2 = jagBuffer.method428();
                npc.updateHitData(k2, l1, loopCycle);
                npc.loopCycleStatus = loopCycle + 300;
                npc.currentHealth = jagBuffer.method428();
                npc.maxHealth = jagBuffer.method427();
            }
            if ((l & 2) != 0) {
                npc.desc = EntityDef.forID(jagBuffer.method436());
                npc.anInt1540 = npc.desc.aByte68;
                npc.anInt1504 = npc.desc.anInt79;
                npc.anInt1554 = npc.desc.walkAnimation;
                npc.anInt1555 = npc.desc.anInt58;
            ...
            if ((l & 4) != 0) {
                npc.anInt1538 = jagBuffer.method434();
                npc.anInt1539 = jagBuffer.method434();
            }
        }
    }
    ...
    private void buildAtNPCMenu(EntityDef entityDef, int i, int j, int k) {
        ...
        if (spellSelected == 1) {
            ...
            if (entityDef.actions != null) {
                for (int l = 4; l >= 0; l--)
                    if (entityDef.actions[l] != null && !entityDef.actions[l]
            ...
            if (entityDef.actions != null) {
                for (int i1 = 4; i1 >= 0; i1--)
                    if (entityDef.actions[i1] != null && entityDef.actions[i1]
                            .equalsIgnoreCase("attack")) {
                        char c = '\0';
    ...
    private void buildAtPlayerMenu(int i, int j, Player player, int k) {
        ...
        String s;
        if (player.skill == 0)
            s = player.name + combatDiffColor(myPlayer.combatLevel,
                    player.combatLevel) + " (level-" + player.combatLevel + ")";
        else
            ...
            if (anIntArray1250[i] <= 0) {
                ...
                try {
                    if (anIntArray1207[i] == anInt874 && anIntArray1241[i] == anInt1289) {
                        ...
                        JagBuffer stream1 = Sounds.method241(anIntArray1241[i],
                                anIntArray1207[i]);
                        if (System.currentTimeMillis() + (stream1.currentOffset / 22) > aLong1172 + (anInt1257 / 22)) {
    ...
    public final void connectServer() {
        ...
        while (expectedCRCs[8] == 0) {
            ...
            try {
                DataInputStream datainputstream = openJagGrabInputStream("crc" + (int) (Math
                        .random() * 99999999D) + "-" + 317);
                JagBuffer class30_sub2_sub2 = new JagBuffer(new byte[40]);
    ...
    void startUp() {
        ...
        try {
            ...
            Model
                    .method459(onDemandFetcher.getVersionCount(0), onDemandFetcher);
            preloadModels();
            if (!lowMem) {
                nextSong = 0;
                try {
            ...
            if (decompressors[0] != null) {
                ...
                onDemandFetcher.method558(3, onDemandFetcher.method562(0, 48,
                        47));
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 48,
                        47));
                onDemandFetcher.method558(3, onDemandFetcher.method562(0, 48,
                        48));
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 48,
                ...
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 48,
                        49));
                onDemandFetcher.method558(3, onDemandFetcher.method562(0, 47,
                        47));
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 47,
                        47));
                onDemandFetcher.method558(3, onDemandFetcher.method562(0, 47,
                        48));
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 47,
                        48));
                onDemandFetcher.method558(3, onDemandFetcher.method562(0, 148,
                        48));
                onDemandFetcher.method558(3, onDemandFetcher.method562(1, 148,
                        48));
                k = onDemandFetcher.getNodeCount();
                while (onDemandFetcher.getNodeCount() > 0) {
            ...
            multicombat = new Sprite(streamLoader_2, "Overlay_multiway", 0);
            ...
            frame = new RSImageProducer(sprite.myWidth, sprite.myHeight,
                    getGameComponent());
            sprite.method346(0, 0);
    ...
    private void method91(JagBuffer jagBuffer, int i) {
        while (jagBuffer.bitPosition + 10 < i * 8) {
            int j = jagBuffer.readBits(11);
            if (j == 2047)
                break;
            ...
            int k = jagBuffer.readBits(1);
            if (k == 1)
                anIntArray894[anInt893++] = j;
            int l = jagBuffer.readBits(1);
            int i1 = jagBuffer.readBits(5);
            if (i1 > 15)
                i1 -= 32;
            int j1 = jagBuffer.readBits(5);
            if (j1 > 15)
                j1 -= 32;
    ...
    private void processMainScreenClick() {
        ...
        if (super.clickMode3 == 1) {
            ...
            if (i >= 0 && j >= 0 && i < 146 && j < 151) {
                ...
                if (flag1) {
                    jagBuffer.writeWordBigEndian(i);
                    jagBuffer.writeWordBigEndian(j);
                    jagBuffer.writeWord(minimapInt1);
                    jagBuffer.writeWordBigEndian(57);
                    jagBuffer.writeWordBigEndian(minimapInt2);
                    jagBuffer.writeWordBigEndian(minimapInt3);
                    jagBuffer.writeWordBigEndian(89);
                    jagBuffer.writeWord(myPlayer.x);
                    jagBuffer.writeWord(myPlayer.y);
                    jagBuffer.writeWordBigEndian(anInt1264);
                    jagBuffer.writeWordBigEndian(63);
                }
            }
            anInt1117++;
            if (anInt1117 > 1151) {
                anInt1117 = 0;
                jagBuffer.createFrame(246);
                jagBuffer.writeWordBigEndian(0);
                int l = jagBuffer.currentOffset;
                if ((int) (Math.random() * 2D) == 0)
                    jagBuffer.writeWordBigEndian(101);
                jagBuffer.writeWordBigEndian(197);
                jagBuffer.writeWord((int) (Math.random() * 65536D));
                jagBuffer.writeWordBigEndian((int) (Math.random() * 256D));
                jagBuffer.writeWordBigEndian(67);
                jagBuffer.writeWord(14214);
                if ((int) (Math.random() * 2D) == 0)
                    jagBuffer.writeWord(29487);
                jagBuffer.writeWord((int) (Math.random() * 65536D));
                if ((int) (Math.random() * 2D) == 0)
                    jagBuffer.writeWordBigEndian(220);
                jagBuffer.writeWordBigEndian(180);
                jagBuffer.writeBytes(jagBuffer.currentOffset - l);
            }
        }
    }
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            int k = 35;
            g.drawString(
                    "Sorry, an error has occured whilst loading RuneScape", 30, k);
            k += 50;
        ...
        if (genericLoadingError) {
            ...
            g.drawString("http://www.jagex.com", 50, 150);
        }
        if (rsAlreadyLoaded) {
            aBoolean831 = false;
            g.setColor(Color.yellow);
            int l = 35;
            g.drawString(
                    "Error a copy of RuneScape already appears to be loaded", 30, l);
            l += 50;
            g.setColor(Color.white);
    ...
    private void method98(Entity entity) {
        if (entity.anInt1548 == loopCycle || entity.anim == -1 || entity.anInt1529 != 0 || entity.anInt1528 + 1 > Animation.anims[entity.anim]
    ...
    private void method101(Entity entity) {
        ...
        if (entity.anInt1517 != -1) {
            ...
            entity.anInt1519++;
            if (entity.anInt1518 < animation.anInt352 && entity.anInt1519 > animation
        ...
        if (entity.anInt1520 != -1 && loopCycle >= entity.anInt1523) {
            ...
            for (entity.anInt1522++; entity.anInt1521 < animation_1.anInt352 && entity.anInt1522 > animation_1
        ...
        if (entity.anim != -1 && entity.anInt1529 == 0) {
            try {
                ...
                for (entity.anInt1528++; entity.anInt1527 < animation_3.anInt352 && entity.anInt1528 > animation_3
    ...
    private void drawGameScreen() {
        ...
        if (backDialogID == -1) {
            ...
            if (super.mouseX > 448 && super.mouseX < 560 && super.mouseY > 332)
                method65(463, 77, super.mouseX - 17, super.mouseY - 357,
        ...
        if (tabAreaAltered) {
            if (anInt1054 != -1 && anInt1054 == tabID) {
                anInt1054 = -1;
                jagBuffer.createFrame(120);
                jagBuffer.writeWordBigEndian(tabID);
            }
                ...
                if (class9_1.type == 2) {
                    ...
                    if (class9_1.aByte254 == 0) {
                        ...
                        DrawingArea.method335(j3, l2, class9_1.width,
                                class9_1.height, 256 - (class9_1.aByte254 & 0xff),
                                k2);
                    else
                    ...
                    for (int l6 = l2 + textDrawingArea.anInt1497; s.length() > 0; l6 += textDrawingArea.anInt1497) {
                        if (s.indexOf("%") != -1) {
                            do {
                                ...
                                if (k7 == -1)
                                    break;
                                s = s.substring(0, k7) + interfaceIntToString(extractInterfaceValues(
                                        class9_1, 0)) + s.substring(k7 + 2);
                            } while (true);
                            do {
                                int l7 = s.indexOf("%2");
                                if (l7 == -1)
                                    break;
                                s = s.substring(0, l7) + interfaceIntToString(extractInterfaceValues(
                                        class9_1, 1)) + s.substring(l7 + 2);
                            } while (true);
                            do {
                                int i8 = s.indexOf("%3");
                                if (i8 == -1)
                                    break;
                                s = s.substring(0, i8) + interfaceIntToString(extractInterfaceValues(
                                        class9_1, 2)) + s.substring(i8 + 2);
                            } while (true);
                            do {
                                int j8 = s.indexOf("%4");
                                if (j8 == -1)
                                    break;
                                s = s.substring(0, j8) + interfaceIntToString(extractInterfaceValues(
                                        class9_1, 3)) + s.substring(j8 + 2);
                            } while (true);
                            do {
                                int k8 = s.indexOf("%5");
                                if (k8 == -1)
                                    break;
                                s = s.substring(0, k8) + interfaceIntToString(extractInterfaceValues(
                                        class9_1, 4)) + s.substring(k8 + 2);
                            } while (true);
                        }
                        int l8 = s.indexOf("\\n");
                        String s1;
                        ...
                        if (class9_1.centerText)
                            textDrawingArea.method382(i4,
                                    k2 + class9_1.width / 2, s1, l6,
                                    class9_1.textShadow);
                        else
    ...
    private void method107(int i, int j, JagBuffer jagBuffer, Player player) {
        if ((i & 0x400) != 0) {
            player.anInt1543 = jagBuffer.method428();
            player.anInt1545 = jagBuffer.method428();
            player.anInt1544 = jagBuffer.method428();
            player.anInt1546 = jagBuffer.method428();
            player.anInt1547 = jagBuffer.method436() + loopCycle;
            player.anInt1548 = jagBuffer.method435() + loopCycle;
            player.anInt1549 = jagBuffer.method428();
            player.method446();
        }
        if ((i & 0x100) != 0) {
            player.anInt1520 = jagBuffer.method434();
            int k = jagBuffer.readDWord();
        ...
        if ((i & 8) != 0) {
            int l = jagBuffer.method434();
            if (l == 65535)
                l = -1;
            int i2 = jagBuffer.method427();
        ...
        if ((i & 4) != 0) {
            player.textSpoken = jagBuffer.readString();
        ...
        if ((i & 0x80) != 0) {
            int i1 = jagBuffer.method434();
            int j2 = jagBuffer.readUnsignedByte();
            int j3 = jagBuffer.method427();
            int k3 = jagBuffer.currentOffset;
            if (player.name != null && player.visible) {
                ...
                if (!flag && anInt1251 == 0)
                    try {
                        aStream_834.currentOffset = 0;
                        jagBuffer.method442(j3, 0, aStream_834.buffer);
                        aStream_834.currentOffset = 0;
            ...
            jagBuffer.currentOffset = k3 + j3;
        }
        if ((i & 1) != 0) {
            player.interactingEntity = jagBuffer.method434();
            if (player.interactingEntity == 65535)
                player.interactingEntity = -1;
        }
        if ((i & 0x10) != 0) {
            int j1 = jagBuffer.method427();
            byte abyte0[] = new byte[j1];
            JagBuffer stream_1 = new JagBuffer(abyte0);
            jagBuffer.readBytes(j1, 0, abyte0);
            aStreamArray895s[j] = stream_1;
            player.updatePlayer(stream_1);
        }
        if ((i & 2) != 0) {
            player.anInt1538 = jagBuffer.method436();
            player.anInt1539 = jagBuffer.method434();
        }
        if ((i & 0x20) != 0) {
            int k1 = jagBuffer.readUnsignedByte();
            int k2 = jagBuffer.method426();
            player.updateHitData(k2, k1, loopCycle);
            player.loopCycleStatus = loopCycle + 300;
            player.currentHealth = jagBuffer.method427();
            player.maxHealth = jagBuffer.readUnsignedByte();
        }
        if ((i & 0x200) != 0) {
            int l1 = jagBuffer.readUnsignedByte();
            int l2 = jagBuffer.method428();
            player.updateHitData(l2, l1, loopCycle);
            player.loopCycleStatus = loopCycle + 300;
            player.currentHealth = jagBuffer.readUnsignedByte();
            player.maxHealth = jagBuffer.method427();
        }
    }
    ...
    private void method108() {
        try {
            ...
            if (anInt1005 > 1512) {
                anInt1005 = 0;
                jagBuffer.createFrame(77);
                jagBuffer.writeWordBigEndian(0);
                int i2 = jagBuffer.currentOffset;
                jagBuffer.writeWordBigEndian((int) (Math.random() * 256D));
                jagBuffer.writeWordBigEndian(101);
                jagBuffer.writeWordBigEndian(233);
                jagBuffer.writeWord(45092);
                if ((int) (Math.random() * 2D) == 0)
                    jagBuffer.writeWord(35784);
                jagBuffer.writeWordBigEndian((int) (Math.random() * 256D));
                jagBuffer.writeWordBigEndian(64);
                jagBuffer.writeWordBigEndian(38);
                jagBuffer.writeWord((int) (Math.random() * 65536D));
                jagBuffer.writeWord((int) (Math.random() * 65536D));
                jagBuffer.writeBytes(jagBuffer.currentOffset - i2);
            }
            int j2 = k1 * 192;
            if (j2 > 0x17f00)
                j2 = 0x17f00;
            ...
            Signlink
                    .reporterror("glfc_ex " + myPlayer.x + "," + myPlayer.y + "," + anInt1014 + "," + anInt1015 + "," + anInt1069 + "," + anInt1070 + "," + baseX + "," + baseY);
            throw new RuntimeException("eek");
        }
    }
    ...
    private void draw3dScreen() {
        ...
        if (crossType == 1) {
            ...
            if (anInt1142 > 67) {
                anInt1142 = 0;
                jagBuffer.createFrame(78);
            }
        }
        if (crossType == 2)
            crosses[4 + crossIndex / 100].drawSprite(crossX - 8 - 4,
                    crossY - 8 - 4);
        if (openWalkableInterfaceID != -1) {
            method119(anInt945, openWalkableInterfaceID);
            drawInterface(0, 0, RSInterface.interfaceCache[openWalkableInterfaceID], 0);
        }
        if (openInterfaceID != -1) {
        ...
        if (!menuOpen) {
            ...
            drawMenu();
        if (anInt1055 == 1)
            multicombat.drawSprite(472, 296);
        if (fpsOn) {
            char c = '\u01FB';
            int k = 20;
            int i1 = 0xffff00;
        ...
        if (anInt1104 != 0) {
            ...
            if (j < 10)
                aTextDrawingArea_1271
                        .method385(
                                0xffff00,
                                "Please log out to save your character - system update in: " + l + ":0" + j,
                                329, 4);
            else
                aTextDrawingArea_1271
                        .method385(
                                0xffff00,
                                "Please log out to save your character - system update in: " + l + ":" + j,
                                329, 4);
            anInt849++;
            if (anInt849 > 75) {
                anInt849 = 0;
                jagBuffer.createFrame(148);
            }
        }
    }
        ...
        try {
            ...
            for (int k = 0; k < friendsCount; k++)
                if (friendsListAsLongs[k] == l) {
                    pushMessage(
                            "Please remove " + s + " from your friend list first",
                            0, "");
                    return;
                }
            ...
            needDrawTabArea = true;
            jagBuffer.createFrame(133);
            jagBuffer.writeQWord(l);
            return;
        } catch (RuntimeException runtimeexception) {
            Signlink
                    .reporterror("45688, " + l + ", " + 4 + ", " + runtimeexception
                            .toString());
        }
        throw new RuntimeException();
    }
    ...
    private void method115() {
        if (loadingStage == 2) {
            for (Class30_Sub1 class30_sub1 = (Class30_Sub1) aClass19_1179
                ...
                if (class30_sub1.anInt1294 == 0) {
                    if (class30_sub1.anInt1299 < 0 || ObjectManager.method178(
                            class30_sub1.anInt1299, class30_sub1.anInt1301)) {
                    ...
                    if (class30_sub1.anInt1302 == 0 && class30_sub1.anInt1297 >= 1 && class30_sub1.anInt1298 >= 1 && class30_sub1.anInt1297 <= 102 && class30_sub1.anInt1298 <= 102 && (class30_sub1.anInt1291 < 0 || ObjectManager
    ...
    private void method117(JagBuffer jagBuffer) {
        jagBuffer.initBitAccess();
        int j = jagBuffer.readBits(1);
        if (j == 0)
            return;
        int k = jagBuffer.readBits(2);
        if (k == 0) {
            anIntArray894[anInt893++] = myPlayerIndex;
            return;
        }
        if (k == 1) {
            int l = jagBuffer.readBits(3);
        ...
        if (k == 2) {
            int i1 = jagBuffer.readBits(3);
            myPlayer.moveInDir(true, i1);
            int l1 = jagBuffer.readBits(3);
            myPlayer.moveInDir(true, l1);
            int j2 = jagBuffer.readBits(1);
            if (j2 == 1)
                anIntArray894[anInt893++] = myPlayerIndex;
            return;
        }
        if (k == 3) {
            plane = jagBuffer.readBits(2);
            int j1 = jagBuffer.readBits(1);
            int i2 = jagBuffer.readBits(1);
            if (i2 == 1)
                anIntArray894[anInt893++] = myPlayerIndex;
            int k2 = jagBuffer.readBits(7);
            int l2 = jagBuffer.readBits(7);
    ...
    private void delIgnore(long l) {
        try {
            ...
            Signlink
                    .reporterror("47229, " + 3 + ", " + l + ", " + runtimeexception
                            .toString());
        }
        throw new RuntimeException();
    }
        ...
        try {
            ...
            do {
                ...
                if (j1 == 4) {
                    ...
                    int k2 = ai[l++];
                    if (k2 >= 0 && k2 < ItemDef.totalItems && (!ItemDef
                            .forID(k2).membersObject || isMembers)) {
                ...
                if (j1 == 10) {
                    ...
                    int l2 = ai[l++] + 1;
                    if (l2 >= 0 && l2 < ItemDef.totalItems && (!ItemDef
                            .forID(l2).membersObject || isMembers)) {
    ...
    private void drawMinimap() {
        ...
        aClass30_Sub2_Sub1_Sub1_1263.method352(151, i, anIntArray1229,
                256 + minimapInt3, anIntArray1052, l2, 9, 54, 146, j);
            ...
            if (chatMessages[j] != null) {
                ...
                if ((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s))) {
                    ...
                    if (super.mouseX > 4 && super.mouseY - 4 > l - 10 && super.mouseY - 4 <= l + 3) {
                        int i1 = aTextDrawingArea_1271
                                .getTextWidth("From:  " + s + chatMessages[j]) + 25;
                        if (i1 > 450)
                            i1 = 450;
    ...
    private void method134(JagBuffer jagBuffer) {
        int j = jagBuffer.readBits(8);
        if (j < playerCount) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            if (j1 == 0) {
                ...
                if (k1 == 0) {
                    ...
                    playerIndices[playerCount++] = i1;
                    player.anInt1537 = loopCycle;
                    int i2 = jagBuffer.readBits(3);
                    player.moveInDir(true, i2);
                    int k2 = jagBuffer.readBits(3);
                    player.moveInDir(true, k2);
                    int l2 = jagBuffer.readBits(1);
                    if (l2 == 1)
                        anIntArray894[anInt893++] = i1;
                } else if (k1 == 3)
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 2) {
            ...
            chatTextDrawingArea
                    .method389(
                            ...
                            c / 2 - 90,
                            0xffffff,
                            "Username: " + myUsername + ((loginScreenCursorPos == 0) & (loopCycle % 40 < 20) ? "@yel@|"
                                    : ""), j);
            j += 15;
            chatTextDrawingArea
                    .method389(
                            ...
                            c / 2 - 88,
                            0xffffff,
                            "Password: " + TextClass.passwordAsterisks(myPassword) + ((loginScreenCursorPos == 1) & (loopCycle % 40 < 20) ? "@yel@|"
                                    : ""), j);
            j += 15;
            if (!flag) {
                int i1 = c / 2 - 80;
        ...
        if (loginScreenState == 3) {
            ...
            k += 15;
            chatTextDrawingArea.method382(0xffffff, c / 2,
                    "click on cancel, and press the existing", k, true);
            k += 15;
            chatTextDrawingArea.method382(0xffffff, c / 2,
                    "user button, and just log in with any username", k, true);
            k += 15;
            chatTextDrawingArea.method382(0xffffff, c / 2,
                    "and password that is not already being used!", k, true);
            k += 15;
            int j1 = c / 2;
            int i2 = c1 / 2 + 50;
    ...
    private void method137(JagBuffer stream1, int i) {
        if (i == 84) {
            int j = stream1.readUnsignedByte();
            int i3 = anInt1268 + (j >> 4 & 7);
            int l5 = anInt1269 + (j & 7);
            int k8 = stream1.readUnsignedShort();
            int j11 = stream1.readUnsignedShort();
            int k13 = stream1.readUnsignedShort();
        ...
        if (i == 105) {
            ...
            int l8 = stream1.readUnsignedShort();
        ...
        if (i == 215) {
            ...
            int i14 = stream1.readUnsignedShort();
        ...
        if (i == 156) {
            ...
            int j9 = stream1.readUnsignedShort();
            ...
            if (i4 >= 0 && l6 >= 0 && i4 < 103 && l6 < 103) {
                ...
                if (i16 == 0) {
                    ...
                    if (object1 != null) {
                        ...
                        if (i12 == 2) {
                            object1.aClass30_Sub2_Sub4_278 = new Animable_Sub5(
                                    j21, 4 + j14, 2, l18, k19, i18, j20, i17, false);
                            object1.aClass30_Sub2_Sub4_279 = new Animable_Sub5(
                                    j21, j14 + 1 & 3, 2, l18, k19, i18, j20, i17,
                                    false);
                        } else {
                            object1.aClass30_Sub2_Sub4_278 = new Animable_Sub5(
                                    j21, j14, i12, l18, k19, i18, j20, i17, false);
                        }
                    }
                }
                if (i16 == 1) {
                    ...
                    if (object2 != null)
                        object2.aClass30_Sub2_Sub4_504 = new Animable_Sub5(
                                object2.uid >> 14 & 0x7fff, 0, 4, l18, k19, i18,
                                j20, i17, false);
                }
                if (i16 == 2) {
                    ...
                    if (i12 == 11)
                        i12 = 10;
                    if (object5 != null)
                        object5.aClass30_Sub2_Sub4_521 = new Animable_Sub5(
                                object5.uid >> 14 & 0x7fff, j14, i12, l18, k19,
                                i18, j20, i17, false);
                }
                if (i16 == 3) {
                    Object3 object3 = worldController.method299(l6, i4, plane);
                    if (object3 != null)
                        object3.aClass30_Sub2_Sub4_814 = new Animable_Sub5(
                                object3.uid >> 14 & 0x7fff, j14, 22, l18, k19, i18,
                                j20, i17, false);
                }
            }
            return;
        ...
        if (i == 147) {
            ...
            if (player != null) {
                ...
                Model model = objectdef.method578(i19, l19, l21, i22, j22, k22,
                        -1);
                if (model != null) {
        ...
        if (i == 4) {
            ...
            int j10 = stream1.readUnsignedShort();
            int k12 = stream1.readUnsignedByte();
            int i15 = stream1.readUnsignedShort();
            if (l4 >= 0 && k7 >= 0 && l4 < 104 && k7 < 104) {
                l4 = l4 * 128 + 64;
                k7 = k7 * 128 + 64;
                Animable_Sub3 animable_sub3 = new Animable_Sub3(plane,
                        loopCycle, i15, j10, method42(plane, k7, l4) - k12, k7, l4);
        ...
        if (i == 44) {
            ...
            int i5 = stream1.readUnsignedShort();
        ...
        if (i == 117) {
            ...
            int k15 = stream1.readSignedShort();
            int l16 = stream1.readUnsignedShort();
            int l17 = stream1.readUnsignedByte() * 4;
            int k18 = stream1.readUnsignedByte() * 4;
            int j19 = stream1.readUnsignedShort();
            int i20 = stream1.readUnsignedShort();
            ...
            if (k5 >= 0 && j8 >= 0 && k5 < 104 && j8 < 104 && i11 >= 0 && j13 >= 0 && i11 < 104 && j13 < 104 && l16 != 65535) {
                ...
                i11 = i11 * 128 + 64;
                j13 = j13 * 128 + 64;
                Animable_Sub4 animable_sub4 = new Animable_Sub4(l20, k18,
                        j19 + loopCycle, i20 + loopCycle, i21, plane, method42(
                        plane, j8, k5) - l17, j8, k5, k15, l16);
                animable_sub4.method455(j19 + loopCycle, j13, method42(plane,
                        j13, i11) - k18, i11);
    ...
    private void method139(JagBuffer jagBuffer) {
        jagBuffer.initBitAccess();
        int k = jagBuffer.readBits(8);
        if (k < npcCount) {
        ...
        for (int i1 = 0; i1 < k; i1++) {
            ...
            if (k1 == 0) {
                ...
                if (l1 == 0) {
                    ...
                    int k2 = jagBuffer.readBits(1);
                    if (k2 == 1)
                        anIntArray894[anInt893++] = j1;
                } else if (l1 == 2) {
                    npcIndices[npcCount++] = j1;
                    npc.anInt1537 = loopCycle;
                    int j2 = jagBuffer.readBits(3);
                    npc.moveInDir(true, j2);
                    int l2 = jagBuffer.readBits(3);
                    npc.moveInDir(true, l2);
                    int i3 = jagBuffer.readBits(1);
                    if (i3 == 1)
                        anIntArray894[anInt893++] = j1;
                } else if (l1 == 3)
    ...
    private void markMinimap(Sprite sprite, int i, int j) {
        ...
        int l1 = j * j1 - i * i1 >> 16;
        if (l > 2500) {
            sprite.drawSprite(((94 + k1) - sprite.anInt1444 / 2) + 4 + 30,
                    83 - l1 - sprite.anInt1445 / 2 - 4 + 5);
        } else {
            sprite.drawSprite(((94 + k1) - sprite.anInt1444 / 2) + 4 + 30,
                    83 - l1 - sprite.anInt1445 / 2 - 4 + 5);
        }
                ...
                if (j1 == 2) {
                    ...
                    if (class46_1.aBoolean767)
                        aClass11Array1230[j].method216(l2, class46_1.anInt744,
                                i1, i, class46_1.anInt761, class46_1.aBoolean757);
                }
                if (j1 == 3) {
    ...
    private void updatePlayers(int i, JagBuffer jagBuffer) {
        anInt839 = 0;
        anInt893 = 0;
        method117(jagBuffer);
        method134(jagBuffer);
        method91(jagBuffer, i);
        method49(jagBuffer);
        for (int k = 0; k < anInt839; k++) {
            int l = anIntArray840[k];
        ...
        if (jagBuffer.currentOffset != i) {
            Signlink
                    .reporterror("Error packet size mismatch in getplayer pos:" + jagBuffer.currentOffset + " psize:" + i);
            throw new RuntimeException("eek");
        }
        for (int i1 = 0; i1 < playerCount; i1++)
            if (playerArray[playerIndices[i1]] == null) {
                Signlink
                        .reporterror(myUsername + " null entry in pl list - pos:" + i1 + " size:" + playerCount);
                throw new RuntimeException("eek");
            }
    ...
    private boolean parsePacket() {
        ...
        try {
            ...
            if (pktType == 134) {
                ...
                int skillExperience = inStream.method439();
                int skillLevel = inStream.readUnsignedByte();
                experience[skillId] = skillExperience;
                level[skillId] = skillLevel;
                maxStats[skillId] = 1;
                for (int k20 = 0; k20 < 98; k20++)
                    if (skillExperience >= anIntArray1019[k20])
            ...
            if (pktType == 50) {
                ...
                for (boolean flag6 = false; !flag6; ) {
                    ...
                    for (int k29 = 0; k29 < friendsCount - 1; k29++)
                        if (friendsNodeIDs[k29] != node && friendsNodeIDs[k29 + 1] == node || friendsNodeIDs[k29] == 0 && friendsNodeIDs[k29 + 1] != 0) {
            ...
            if (pktType == 196) {
                ...
                if (!flag5 && anInt1251 == 0)
                    try {
                        ...
                        if (l21 == 2 || l21 == 3)
                            pushMessage(s9, 7, "@cr2@" + TextClass
                                    .fixName(TextClass.nameForLong(l5)));
                        else if (l21 == 1)
                            pushMessage(s9, 7, "@cr1@" + TextClass
                                    .fixName(TextClass.nameForLong(l5)));
                        else
            ...
            Signlink
                    .reporterror("T1 - " + pktType + "," + pktSize + " - " + anInt842 + "," + anInt843);
            resetLogout();
        } catch (IOException _ex) {
            dropClient();
        } catch (Exception exception) {
        ...
        for (int i2 = 0; i2 < 5; i2++)
            if (aBooleanArray876[i2]) {
                int j2 = (int) ((Math.random() * (anIntArray873[i2] * 2 + 1) - anIntArray873[i2]) + Math
                        .sin(anIntArray1030[i2] * (anIntArray928[i2] / 100D)) * anIntArray1203[i2]);
                if (i2 == 0)
                    xCameraPos += j2;
                if (i2 == 1)
                    zCameraPos += j2;
    ...
    public Client() {
        ...
        aBoolean831 = false;
        aStream_834 = new JagBuffer(new byte[5000]);
        npcArray = new NPC[16384];
        npcIndices = new int[16384];
        anIntArray840 = new int[1000];
        aStream_847 = JagBuffer.create();
        aBoolean848 = true;
        openInterfaceID = -1;
        experience = new int[Skills.skillsCount];
        aBoolean872 = false;
        ...
        aStreamArray895s = new JagBuffer[maxPlayers];
        anInt897 = 1;
        anIntArrayArray901 = new int[104][104];
        anInt902 = 0x766654;
        aByteArray912 = new byte[16384];
        level = new int[Skills.skillsCount];
    ...
    private JagBuffer[] aStreamArray895s;
    ...
    private int openWalkableInterfaceID;
