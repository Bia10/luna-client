...
public final class JagBuffer extends NodeSub {

    public static JagBuffer create() {
        synchronized (nodeList) {
            JagBuffer jagBuffer = null;
            if (anInt1412 > 0) {
                anInt1412--;
                jagBuffer = (JagBuffer) nodeList.popHead();
            }
            if (jagBuffer != null) {
        ...
        JagBuffer stream_1 = new JagBuffer();
    ...
    public void writeQWord(long l) {
        try {
            ...
            Signlink
                .reporterror("14395, " + 5 + ", " + l + ", " + runtimeexception
                    .toString());
